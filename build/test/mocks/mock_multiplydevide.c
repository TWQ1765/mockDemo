...
static struct mock_multiplydevideInstance
{
...
void mock_multiplydevide_Verify(void)
{
...
void mock_multiplydevide_Init(void)
{
  mock_multiplydevide_Destroy();
}

void mock_multiplydevide_Destroy(void)
{
